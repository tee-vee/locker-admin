...
curl.exe --dns-servers 8.8.8.8 -k -vv -S -XPOST -H "Accept: application/json" -H "Content-Type: application/json" -H "x-api-key: %APIKEY%" -H "Cache-Control: no-cache" --data @%DATAFILE% --url %url%
